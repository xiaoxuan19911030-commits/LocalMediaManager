...
public sealed class ImageAssetWorkflowTests : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        foreach (string file in new[] { "0001_InitialSchema.sql", "0003_UserStateAuditAndRatingMemory.sql", "0004_LibraryScanWorkflow.sql", "0005_MetadataSyncWorkflow.sql", "0006_ImageAssetWorkflow.sql" }) {
