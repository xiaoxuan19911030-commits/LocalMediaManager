...
function TaskCard({ task, busy, selected, onSelect, onMutate, onCancel, onLogs }: { task: TaskItem; busy?: number; selected: boolean; onSelect: (checked: boolean) => void; onMutate: (task: TaskItem, action: 'pause' | 'resume' | 'retry') => void; onCancel: () => void; onLogs: () => void }) {
